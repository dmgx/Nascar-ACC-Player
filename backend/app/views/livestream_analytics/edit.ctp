...
<?php echo $this->Form->create('LivestreamAnalytic');?>
	<fieldset>
		<legend><?php __('Edit Livestream Analytic'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('LivestreamAnalytic.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('LivestreamAnalytic.id'))); ?></li>
